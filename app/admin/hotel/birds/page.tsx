...
export default function AdminHotelBirdsPage() {
  ...
  const birdRooms = useMemo(() => rooms.filter((r: any) => r.type === 'BIRD').sort((a: any, b: any) => a.roomNumber - b.roomNumber), [rooms]);
  ...
  async function createReservation() {
    const room = birdRooms.find((r: any) => r.id === form.roomId) || birdRooms.find((r: any) => r.roomNumber?.toString() === form.roomNumber);
    if (!room) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-4">
              ...
              <span className="text-gray-700">Hotel • Bird Rooms</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900">Bird Rooms (1–5)</h1>
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1,2,3,4,5].map((num) => {
            const room = birdRooms.find((r:any)=>r.roomNumber === num);
            const status = room?.status || 'AVAILABLE';
            return (
              <div key={num} className="bg-white rounded-lg shadow-sm p-6 border">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <p className="text-sm text-gray-600">Bird Room</p>
              ...
              {(() => {
                const roomEntity = birdRooms.find((r:any)=>r.roomNumber===num);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-lg w-full">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <h2 className="text-xl font-bold text-gray-900">Book Bird Room</h2>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e)=>{
                      ...
                      const r = birdRooms.find((rr:any)=>rr.roomNumber?.toString() === num);
                  ...
                  >
                    ...
                    {[1,2,3,4,5].map((n)=>{
                      const r = birdRooms.find((rr:any)=>rr.roomNumber===n);
          ...
          <div className="bg-white rounded-lg max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-gray-700"><span className="font-medium">Room:</span> Bird Room #{checkingOutReservation.room?.roomNumber || 'N/A'}</p>
